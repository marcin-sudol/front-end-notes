  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          Route,
          { exact: true, path: "/", element: React.createElement(Home, { notes: notes }) },
          notes.map(function (note, index) {
            return React.createElement(Route, { path: note.name, key: index, element: React.createElement(Note, note) });
          })
        ),
